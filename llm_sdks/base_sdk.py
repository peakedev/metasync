...
class BaseLLMSDK(ABC):
    ...
    All SDK plugins must inherit from this class and implement the
    required methods.
    """
    ...
    def get_name(self) -> str:
        ...
        This name must match exactly what's stored in the 'sdk' field
        of model documents.

        Returns:
            str: The SDK identifier (e.g., "ChatCompletionsClient",
    ...
    def validate_config(self, config: Dict[str, Any]) -> None:
        ...
        Check that all required fields for this SDK are present and
        valid. Should raise ValueError with a descriptive message if
        validation fails.
